...
class PosXyThorGvs212(LabradServer):
    ...
    def load_stream_writer_xy(
        self, c, task_name, voltages, period, continuous=False
    ):
    ...
    def read_xy(self, c):
        ...
        with nidaqmx.Task() as task:
            ...
            task.ai_channels.add_ai_voltage_chan(
                chan_name, min_val=-10.0, max_val=10.0
            )
    ...
    def load_sweep_scan_xy(
        ...
        self.load_stream_writer_xy(
            c, "Galvo-load_sweep_scan_xy", voltages, period
        )
    ...
    def load_cross_scan_xy(
        ...
        self.load_stream_writer_xy(
            c, "Galvo-load_cross_scan_xy", voltages, period
        )
    ...
    def load_arb_scan_xy(self, c, x_points, y_points, period):
        ...
        self.load_stream_writer_xy(
            c, "Galvo-load_arb_scan_xy", voltages, period
        )

        return

    @setting(7, radius="v[]", num_steps="i", period="i", returns="*v[]*v[]")
