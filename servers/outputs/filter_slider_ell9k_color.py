# -*- coding: utf-8 -*-
"""
Output server for the Thorlabs ELL9K filter slider, used for color filters.

Created on Tue Aug 4 15:58:30 2020

@author: mccambria

### BEGIN NODE INFO
[info]
name = filter_slider_ell9k_color
version = 1.0
description =
...
class FilterSliderEll9kColor(LabradServer):
    name = 'filter_slider_ell9k_color'
    ...
    async def get_config(self):
        ...
        p.cd('Config')
        p.get('filter_slider_ell9k_color_address')
        p.cd('FilterSliderEll9kFilterColorMapping')
        p.dir()
        result = await p.send()
        return result
...
__server__ = FilterSliderEll9kColor()
