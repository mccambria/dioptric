...
class GalvoAndObjectivePiezo(LabradServer):
    name = 'galvo_and_objective_piezo'
...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++#
    ...
    def load_sweep_xy_scan(self, c, x_center, y_center,
        ...
        self.load_stream_writer_xy(c, 'GalvoAndObjectivePiezo-load_sweep_scan', voltages, period)
    ...
    def load_cross_xy_scan(self, c, x_center, y_center,
        ...
        self.load_stream_writer_xy(c, 'GalvoAndObjectivePiezo-load_cross_scan', voltages, period)
    ...
    def load_x_scan(self, c, x_center, y_center,
        ...
        self.load_stream_writer_xy(c, 'GalvoAndObjectivePiezo-load_x_scan', voltages, period)
...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++#
    ...
    def load_z_scan(self, c, center, scan_range, num_steps, period):
        ...
        self.load_stream_writer_z(c, 'GalvoAndObjectivePiezo-load_z_scan',
                                voltages, period)
        return voltages
