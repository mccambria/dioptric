...
def qua_program(opx, config, args, num_reps):
    ...
    delay, readout_time, laser_name, laser_power, test_delay = args
    ...
    meas_delay = test_delay + laser_delay_time + apd_readout_time
    meas_delay_cc = int( meas_delay // 4)
    ...
    laser_on_time = apd_readout_time  
...
if __name__ == '__main__':
    ...
    num_repeat=1
    delay = 3000
    args=[800, 1000.0, 'cobolt_515', None,5000]
