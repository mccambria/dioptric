    ...
    with program() as seq:
            ...
            with for_(i, 0, i < num_readouts, i + 1):
                ...
                if num_apds == 1:
                    ...
                    measure(
                        ...
                        None,
                        time_tagging.analog(
                            times_gate1_apd, apd_readout_time, counts_gate1_apd
                        ),
                    )
            ...
            with for_(ii, 0, ii < num_readouts, ii + 1):
                if num_apds == 2:
                    ...
                    measure(
                        ...
                        None,
                        time_tagging.analog(
                            times_gate2_apd_0, apd_readout_time, counts_gate2_apd_0
                        ),
                    )
                    measure(
                        "readout",
                        ...
                        None,
                        time_tagging.analog(
                            times_gate2_apd_1, apd_readout_time, counts_gate2_apd_1
                        ),
                    )

                    # assign(counts_gate2_apd_0,4)
                    # assign(counts_gate2_apd_1,6)
                ...
                if num_apds == 1:
                    ...
                    measure(
                        ...
                        None,
                        time_tagging.analog(
                            times_gate2_apd, apd_readout_time, counts_gate2_apd
                        ),
                    )
        ...
        if num_apds == 2:
            with stream_processing():
                counts_st_apd_0.buffer(num_readouts).buffer(num_gates).save_all(
                    "counts_apd0"
                )
                counts_st_apd_1.buffer(num_readouts).buffer(num_gates).save_all(
                    "counts_apd1"
                )
        ...
        if num_apds == 1:
            with stream_processing():
                counts_st_apd.buffer(num_readouts).buffer(num_gates).save_all(
                    "counts_apd0"
                )
                empty_stream.buffer(num_readouts).buffer(num_gates).save_all(
                    "counts_apd1"
                )
...
if __name__ == "__main__":
    ...
    simulation_duration = 18000 // 4  # clock cycle units - 4ns
    num_repeat = 5
    delay = 6000
