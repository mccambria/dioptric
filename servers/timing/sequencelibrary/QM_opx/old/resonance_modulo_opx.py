...
# 
    ...
    results_apd0 = fetching_tool(job, data_list = list_of_streams_apd0, mode="wait_for_all")
    results_apd1 = fetching_tool(job, data_list = list_of_streams_apd1, mode="wait_for_all")
    st=time.time()
    count_sums_list_apd0 = results_apd0.fetch_all()
    count_sums_list_apd1 = results_apd1.fetch_all()
    
    print(time.time()-st)# # print('')
    # print(counts_apd0_gate1)
    # print(counts_apd0_gate2)
    # print(counts_apd1_gate1)
    # print(counts_apd1_gate2)
    # print('')
