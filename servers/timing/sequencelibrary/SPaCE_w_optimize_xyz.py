...
Run the SPaCE measuremnet, while optimizing in x,y, and z each sequence
...
#    We're going to readout the entire sequence, including the clock pulse
    ...
    optimize_z_time = inter_optimize_delay + (z_move_delay + imaging_readout_dur + 300) * num_opti_steps
