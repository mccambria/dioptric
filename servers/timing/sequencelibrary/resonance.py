...
def get_seq(pulse_streamer, config, args):
    ...
    # Laser just on, more or less
#    train = [(front_buffer-laser_delay, LOW), 
#             (transient+readout, HIGH), (meas_buffer, LOW),
#             (transient+readout, HIGH), (meas_buffer+laser_delay, LOW)]
#    train = [(front_buffer-laser_delay, LOW), ()
#             (transient+readout, HIGH), (meas_buffer, HIGH),
#             (transient+readout, HIGH), (meas_buffer+laser_delay-200, HIGH), (200,LOW)]
    train = [(period, HIGH)]
