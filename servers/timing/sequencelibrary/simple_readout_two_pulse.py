...
def get_seq(pulser_wiring, args):
    ...
    # Unpack the args
    galvo_delay, init_delay, read_delay,init_pulse_time,  readout_time, aom_ao_589_pwr, apd_index,\
            init_color_ind, read_color_ind = args
    ...
    galvo_delay = numpy.int64(galvo_delay)
    init_delay = numpy.int64(init_delay)
    read_delay = numpy.int64(read_delay)
