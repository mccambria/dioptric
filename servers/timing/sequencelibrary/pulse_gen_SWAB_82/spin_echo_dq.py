...
def get_seq(pulse_streamer, config, args):
    ...
    if state_ini.value == States.LOW.value:
        ...
        # prep_pi_pulse_high = pi_pulse_high_dur
    ...
    uwave_echo_pulse_dur = echo_pi_pulse_low_1 + echo_pi_pulse_low_2 + \
                echo_pi_pulse_high_1 + echo_pi_pulse_high_2 + \
                echo_pi_pulse_low_1 + echo_pi_pulse_high_1
    # prep_pi_pulse_dur = prep_pi_pulse_low + prep_pi_pulse_high
    # read_pi_pulse_dur = read_pi_pulse_low + read_pi_pulse_high
