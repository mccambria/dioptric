...
def get_seq(pulse_streamer, config, args):
    ...
    uwave_pulse_activ_shrt_low = 0
    uwave_pulse_proxy_shrt_low = 0
    uwave_pulse_activ_shrt_high = 0
    uwave_pulse_proxy_shrt_high = 0
    
    uwave_pulse_activ_long_low = 0
    uwave_pulse_proxy_long_low = 0
    uwave_pulse_activ_long_high = 0
    uwave_pulse_proxy_long_high = 0
