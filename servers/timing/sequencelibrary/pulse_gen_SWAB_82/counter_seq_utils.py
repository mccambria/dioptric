...
def macro_ionize(ion_coord: list[float], do_target_list: list[bool] = None):
    ...
    _macro_pulse_series(
        ion_laser_name, ion_pulse_name, ion_coord, do_target_list=do_target_list
    )


def macro_scc(
    scc_coord: list[list[float]],
    scc_duration: list[int] = None,
    scc_amp: list[float] = None,
