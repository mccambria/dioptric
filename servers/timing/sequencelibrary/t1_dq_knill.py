...
def get_seq(pulser_wiring, args):
    ...
    if low_sig_gen_name == 'tsg4104a':
        rf_low_delay = sig_gen_tsg4104a_delay
    elif low_sig_gen_name == 'sg394':
    ...
    if high_sig_gen_name == 'tsg4104a':
        rf_high_delay = sig_gen_tsg4104a_delay
    elif high_sig_gen_name == 'sg394':
    ...
    train.extend([(init_pi_high, HIGH), (init_pi_low + tau_shrt, LOW), (read_pi_high, HIGH)])
    train.extend([(read_pi_low + mid_duration, LOW)])
    train.extend([(init_pi_high, HIGH), (init_pi_low + tau_long, LOW), (read_pi_high, HIGH)])
    ...
    train.extend([(init_pi_low, HIGH), (init_pi_high + tau_shrt, LOW), (read_pi_low, HIGH)])
    train.extend([(read_pi_high + mid_duration, LOW)])
    train.extend([(init_pi_low, HIGH), (init_pi_high + tau_long, LOW), (read_pi_low, HIGH)])
