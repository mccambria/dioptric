...
#    nv_sig = { 'coords': [0.568, -0.645, 5.0],
            ...
            'resonance_LOW': 2.7951, 'rabi_LOW': 168.2, 'uwave_power_LOW': 15.5,  # 15.5 max
            'resonance_HIGH': 2.9399, 'rabi_HIGH': 227.8, 'uwave_power_HIGH': 14.5}   # 14.5 max
