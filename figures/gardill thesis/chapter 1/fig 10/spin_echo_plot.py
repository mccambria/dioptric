...
def do_plot(data):
    ...
    kpl.plot_points(ax, taus_ms, norm_avg_sig, yerr = norm_avg_sig_ste,color = KplColors.BLUE)
    kpl.plot_line(ax, taus_ms_linspace, fit_func(taus_ms_linspace,*popt),color = KplColors.RED)
