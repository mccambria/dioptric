...
def fit_resonance(
    ...
    if not do_single_gaussian:
        fit_func = lambda freqs, c1, a1, s1, c2, a2, s2: doub_gaus(
            freqs, c1, a1, s1, c2, a2, s2
        )
...
def do_plot(file_list, guess_centers_list):
    ...
    for i in range(len(file_list)):
        ...
        do_single_gaussian = False
        if (
            file == "023_04_10-14_35_56-johnson-nv0_2023_04_06"
        ):  # for the single resonance, just fit a single gaussian
