...
def canny_edge_detector(readout_image_array,num_steps):
    ...
    keep = filter_strong_edges(gradient, width, height, 0.6, 0.9)
    #print (keep)
...
def find_centers(file, do_plot = False):
    ...
    rmax = 31
    steps =80
    threshold = 0.4# percentage of proper pixels on the circle
    ...
    if do_plot:
        ...
        for i in range(len(circles)):
            ...
            ax.plot(x_find, y_find,'g-',  linewidth = 1)
            
            ax.plot(x[y_pos], y[x_pos], 'wo')
...
if __name__ == "__main__":
    file = '2021_10_25-13_54_54-ayrton_101-nv0_2021_10_20.txt'
