...
if sys.version_info.major > 2:
    try:
        from PulseStreamer.tinyrpc3 import RPCClient
...
""")
    ...
    try:
        from PulseStreamer.tinyrpc import RPCClient
        from PulseStreamer.tinyrpc.protocols.jsonrpc import JSONRPCProtocol
        from PulseStreamer.tinyrpc.transports.http import HttpPostClientTransport        
    except Exception as e:
        print(str(e))
        print (
"""
