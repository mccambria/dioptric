...
t1_exp_array = numpy.array([[[States.HIGH, States.LOW],  [0, 100*10**3], 51, 6*10**4, num_runs], # 0.8 hrs, optimize every 1.3 min
                                [[States.HIGH, States.LOW],  [0, 700*10**3], 26, 3.75*10**4, num_runs], # 3.8 hrs, optimize every 5.5 min
                                [[States.HIGH, States.HIGH],  [0, 100*10**3], 51, 6*10**4, num_runs], # 0.8 hrs, optimize every 1.3 min
                                [[States.HIGH, States.HIGH],  [0, 700*10**3], 26, 3.75*10**4, num_runs], # 3.8 hrs, optimize every 5.5 min
