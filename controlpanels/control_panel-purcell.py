...
if __name__ == "__main__":
    ...
    # scc_duration_list = [
    #     median_value if val < lower_bound or val > upper_bound else val
    #     for val in scc_duration_list
    # ]
