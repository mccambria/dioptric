...
t1_exp_array = numpy.array([
    [[States.HIGH, States.LOW], [0, 4*10**6], 21, 3*10**2, 1000],
    [[States.HIGH, States.HIGH], [0, 4*10**6], 21, 3*10**2, 1000],
    [[States.ZERO, States.HIGH], [0, 4*10**6], 21, 3*10**2, 1000],
    [[States.ZERO, States.ZERO], [0, 4*10**6], 21, 3*10**2, 1000]
        ])

contrast = 0.03  # arb
exp_count_rate = 6000  # kcps
readout_window = 300  # ns
