...
# %%      
def main_moving_target(cxn, base_sig, optimize_coords, center_coords, pulse_coords, pulse_time, init_time, init_color, pulse_color, readout_color, disable_optimize=False,wait_time = 0):
    ...
    image_sig['ao_638_pwr'] = red_image_power
    ...
    reset_sig['coords'] = center_coords
    reset_sig['ao_638_pwr'] = red_reset_power
...
#        direct_wiring = pulser_wiring_yellow
    ...
    if pulse_time < 1.1:
        ...
        elif pulse_color =='638a':
            cxn.pulse_streamer.constant([], red_pulse_power, 0)
        time.sleep(pulse_time)
    cxn.pulse_streamer.constant([], 0.0, 0.0)
