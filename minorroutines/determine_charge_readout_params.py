...
if __name__ == "__main__":
    ...
    nv_sig = { 'coords': [0.030, 0.011, -1], 'name': '{}-nv3_2021_12_03'.format(sample_name),
            ...
            'nv-_prep_laser': green_laser, 'nv-_prep_laser_dur': 1E7, 'nv-_prep_laser_filter': 'nd_1.0',
    ...
    readout_powers = np.linspace(0.8, 1.0, 5)
