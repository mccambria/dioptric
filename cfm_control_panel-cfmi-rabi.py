...
if __name__ == "__main__":
    ...
    try:
        ...
        T_min = 0 #us
        T_max = 5000 #us      
        do_dd_cpmg(nv_sig, apd_indices, pi_pulse_reps, step_size, T_min, T_max)
        # num_xy8_reps = 1
