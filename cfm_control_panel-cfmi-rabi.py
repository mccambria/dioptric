...
def do_relaxation(nv_sig,  num_reps, num_runs, scc=False, ):
    min_tau = 0
    max_tau_omega =6e6# 5e6
    max_tau_gamma = 0.05e6
    num_steps_omega = 21
    num_steps_gamma = 21
...
if __name__ == "__main__":
    ...
    nv_sig_0["resonance_HIGH"]= 2.9131
    ...
    try:
        ...
        # do_rabi(nv_sig, nv_sig, States.HIGH, uwave_time_range=[0, 500])
