...
def CommonFunc(serialNumber):
    ...
    result = EXULUSSetScreenHorizontalFlip(
        hdl, 1
    )  # 0: Flip in Horizontal Off;1: Flip in Horizontal On
    if result < 0:
        print("Set Screen Horizontal Flip failed ")
    else:
        print(
            "Set Screen Horizontal Flip : On",
        )
    ...
    result = EXULUSSetScreenVerticalFlip(
        hdl, 1
    )  # 0: Flip in Vertical Off;1: Flip in Vertical On;
    if result < 0:
    ...
    result = EXULUSSetTestPatternStatus(
        hdl, 1
    )  # 0: Test Pattern Off;1: Test Pattern On;
    if result < 0:
