...
if __name__ == "__main__":
    ...
    data = dm.get_raw_data(
        file_stem="2025_09_10-20_32_54-rubin-nv0_2025_09_08", load_npz=True
    )
    ...
    initial_peaks = np.array([[225.123, 239.284], [192.572, 19.583], [20.535, 156.6]])
    # red calibration
    # initial_peaks = np.array([[21.302, 158.911], [193.436, 22.055], [225.831, 241.507]])
    # gree calibration
