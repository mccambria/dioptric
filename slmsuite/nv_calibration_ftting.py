...
if __name__ == "__main__":
    ...
    data = dm.get_raw_data(
        file_stem="2025_09_09-15_34_10-runin-nv0_2025_09_08", load_npz=True
    )
    ...
    initial_peaks = np.array([[226.249, 239.417], [193.694, 19.937], [21.482, 156.838]])
    # red calibration
    # initial_peaks = np.array([[22.388, 40.472], [139.748, 229.945], [216.06, 20.667]])
    # gree calibration
