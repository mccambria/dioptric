...
if __name__ == "__main__":
    ...
    data = dm.get_raw_data(
        file_stem="2025_09_26-20_33_34-rubin-nv0_2025_09_08",
    ...
    nv_coordinates, spot_weights = load_nv_coords(
        ...
        file_path="slmsuite/nv_blob_detection/nv_blob_331nvs.npz"
    ...
    #                    if (val1, val2 is None) or (isinstance(val1, val2l, (int, float)) and not math.isnan(val) and val1 >= 0.80 and val2 >= 0.50]
    ...
    save_results(
        filtered_reordered_coords,
        filtered_reordered_spot_weights,
        filename="slmsuite/nv_blob_detection/nv_blob_329nvs_reordered.npz",
    )
    # save_results(
    #     nv_coordinates,
    #     filtered_reordered_counts,
