...
if __name__ == "__main__":
    ...
    data = dm.get_raw_data(
        file_stem="2025_10_22-01_30_50-combined_image_array", load_npz=True
    )
    ...
    nv_coordinates, spot_weights = load_nv_coords(
        ...
        file_path="slmsuite/nv_blob_detection/nv_blob_650nvs.npz"
    )
    ...
    #     filename="slmsuite/nv_blob_detection/nv_blob_467nvs_reordered.npz",
    # )
