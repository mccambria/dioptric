...
if __name__ == "__main__":
    ...
    include_indices =  [i for i, val in enumerate(snr_float) if val >= 0.02 or val is None]
    # import math
    ...
    filtered_reordered_spot_weights = spot_weights_filtered 
    ...
    save_results(
        ...
        filename="slmsuite/nv_blob_detection/nv_blob_230nvs_reordered.npz",
    )
