...
if __name__ == "__main__":
    ...
    nv_sig = {
        ...
        'coords': [0.255, -0.072, 12], 'name': '{}-nv4_2022_10_19'.format(sample_name),
        'disable_opt': False, "disable_z_opt": True, 'expected_count_rate': 21,
        ...
        'resonance_LOW': 2.871, 'rabi_LOW': 500, 'uwave_power_LOW': 16.5,
