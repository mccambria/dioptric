...
if __name__ == '__main__':
    ...
    nv_sig = { 
        'coords': [0.044, 0.051, 5.0], 'name': '{}-nv4_2022_03_09'.format(sample_name),
        ...
        'resonance_HIGH': 2.8834, 'rabi_HIGH': 190, 'uwave_power_HIGH': 16.5,
        }
            
    # nv_sig = {
    #     'coords': [0.0, 0.0, 5.0], 'name': '{}-search'.format(sample_name),
