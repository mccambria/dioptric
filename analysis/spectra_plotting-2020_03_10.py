...
def plot_spectra(file,folder, wavelength_range, vertical_range, plot_title):
    ...
    return wavelengths[plot_strt_ind : plot_end_ind], counts_cnst_bkgd[plot_strt_ind : plot_end_ind]
...
file_n_g_y_ig_550_10nm = ''
file_n_g_y_ig_660_10nm = ''

if __name__ == '__main__':
    
     
    wvlngth_1, counts_1 = plot_spectra(file_n_g_n_ig_550_5nm, folder_5,  [None, None], [-100, 300],'5 nm Er')
    wvlngth_2, counts_2 = plot_spectra(file_n_g_n_ig_550_10nm, folder_10, [None, None], [-100, 300],'10 nm Er')
    
#    wvlngth_1, counts_1 = plot_spectra(file_n_g_n_ig_660_5nm, folder_5,  [None, None], [-100, 300],'5 nm Er')
#    wvlngth_2, counts_2 = plot_spectra(file_n_g_n_ig_660_10nm, folder_10, [None, None], [-100, 300],'10 nm Er')
...
#    ax.set_ylim([-100, 500]) 
    ax.plot(wvlngth_1, counts_1, label = '5 nm Er')
    ax.plot(wvlngth_2, counts_2, label = '10 nm Er')
    ax.legend()
