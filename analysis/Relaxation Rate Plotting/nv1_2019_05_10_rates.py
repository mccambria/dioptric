...
# The data
nv1_splitting_list = [ 19.5, 27.7, 28.9, 41.9, 32.7, 51.8, 97.8, 116, 268, 563.6, 1016.8]
nv1_omega_avg_list = [ 0.83, 1.30,  1.000, 1.11, 1.42, 1.85, 1.41, 1.18, 1.04, 1.19, 0.58]
nv1_omega_error_list = numpy.array([ 0.04, 0.06, 0.016, 0.05, 0.05, 0.08, 0.05, 0.06, 0.04, 0.06, 0.03])*2
nv1_gamma_avg_list = [58.3, 64.5, 56.4, 23.5, 42.6, 13.1, 3.91, 4.67, 1.98, 0.70, 0.41]
nv1_gamma_error_list = numpy.array([1.4, 1.4, 1.3, 0.5, 0.9, 0.2, 0.1, 0.11, 0.1, 0.05, 0.05])*2
