...
#    fit_param_bounds = ([(0 / readout) * 10**6, -5., 0., -50.], 
#                        [(10000 / readout) * 10**6, 5., 0.1, 80.])
    try:
...
#                                        bounds = fit_param_bounds
    ...
    init_fit = ((100. / readout) * 10**6, z_center, (z_range / 2), 0.)
#    fit_param_bounds = ([(0 / readout) * 10**6, 40, 0, -10], 
#                        [(10000 / readout) * 10**6, 60, 3, 30])
    try:
