...
if __name__ == "__main__":
    ...
    file_stem = ["2025_10_12-10_27_20-rubin-nv0_2025_09_08"]
    all_file_ids_str = "_".join(map(str, file_stem ))

    now = datetime.now()
    date_time_str = now.strftime("%Y%m%d_%H%M%S")
    # file_name = dm.get_file_name(file_id=file_stem[0])
    ...
    data = process_multiple_files(file_stem)
