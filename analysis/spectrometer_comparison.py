...
int_time_linspace = numpy.linspace(0.01,10**7, 1000)

counts_linspace = numpy.linspace(10, 10**10, 1000)
...
def SN_t(t, *params):
    ...
    N_S = photon_flux_p_pixel * quantum_eff * px_p_columns * t
...
ax.plot(int_time_linspace, shot_noise_SNR_time(int_time_linspace, *horiba_BIDD), label = 'shot noise limit')
