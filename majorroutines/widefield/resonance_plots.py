...
def plot_and_save_nv_data(nv_list, freqs, avg_counts, avg_counts_ste, file_path):
    """
    Plot the NV data in a single vertical column and save the figure.
    ...
    """
    # Create a figure with 77 subplots in a single vertical column
    num_nvs = len(nv_list)
    fig, axes_pack = plt.subplots(num_nvs, 1, figsize=(10, num_nvs * 2), sharex=True)
...
if __name__ == "__main__":
    ...
    plot_and_save_nv_data(nv_list, freqs, avg_counts, avg_counts_ste, file_path)
