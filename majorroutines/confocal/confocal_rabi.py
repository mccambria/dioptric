...
from majorroutines.confocal import confocal_base_routine
...
def main(nv_sig, num_steps, num_reps, num_runs, min_tau, max_tau, uwave_ind_list):
    ...
    _pulse_streamer = tb.get_server_pulse_streamer()
    ...
    def run_fn(shuffled_step_inds):
        ...
        _pulse_streamer.stream_load("rabi_seq.py", seq_args_string)
