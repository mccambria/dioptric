...
def qua_program(opx, config, args, num_reps):
    ...
    with program() as seq:
        ...
        measure("readout", "do_apd_0_gate", None, time_tagging.analog(times_gate1_apd_0, 1000, counts_gate1_apd_0))
        measure("readout", "do_apd_1_gate", None, time_tagging.analog(times_gate1_apd_1, 1000, counts_gate1_apd_1))
        ...
        with for_(j, 0, j < counts_gate1_apd_0, j + 1):
            save(5, times_st_apd_0) 
        with for_(k, 0, k < counts_gate1_apd_0, k + 1):
            save(7, times_st_apd_1)
                
 
        with stream_processing():
            counts_st_apd_0.save_all("counts_apd0") 
            counts_st_apd_1.save_all("counts_apd1")
